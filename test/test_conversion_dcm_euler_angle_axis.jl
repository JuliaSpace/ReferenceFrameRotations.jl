...
for k = 1:samples
    ...
    @test    eac1.a ≈ θ      atol = 5e-9
    @test eac1.v[1] ≈ s*v[1] atol = 5e-9
    @test eac1.v[2] ≈ s*v[2] atol = 5e-9
    @test eac1.v[3] ≈ s*v[3] atol = 5e-9

    @test    eac2.a ≈ θ      atol = 5e-9
    @test eac2.v[1] ≈ s*v[1] atol = 5e-9
    @test eac2.v[2] ≈ s*v[2] atol = 5e-9
    @test eac2.v[3] ≈ s*v[3] atol = 5e-9
end
