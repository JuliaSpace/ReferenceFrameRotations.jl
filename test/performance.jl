...
Verify type-inference and zero-allocation performance contracts for numeric type `T`.

# Arguments

- `T::Type`: Numeric type used to instantiate the tested rotation values.
"""
function _test_performance_contracts(::Type{T}) where {T}
