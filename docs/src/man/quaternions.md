...
The sum between quaternions and the multiplication between a quaternion and a
...
The multiplication between quaternions is also defined using the Hamilton
product:
...
\mathbf{q}_1 \cdot \mathbf{q}_2 &= r_1 \cdot r_2 - \mathbf{v}_1 \cdot \mathbf{v}_2 + r_1 \cdot \mathbf{v}_2 + r_2 \cdot \mathbf{v}_1 + \mathbf{v}_1 \times \mathbf{v}_2~.
\end{aligned}
```
